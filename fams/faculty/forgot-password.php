...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT Email FROM tblfaculty WHERE Email=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblfaculty set Password=:newpassword where Email=:email and MobileNumber=:mobile";
