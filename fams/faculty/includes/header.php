...
<nav id="app-navbar" class="navbar navbar-inverse navbar-fixed-top primary">
  ...
  <div class="navbar-header">
    ...
    <a href="dashboard.php" class="navbar-brand">
      ...
      <span class="brand-name">FAMS</span>
    </a>
  </div><!-- .navbar-header -->
...
<li class="dropdown">
  <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="zmdi zmdi-hc-lg zmdi-help"></i></a>
  <ul class="dropdown-menu animated flipInY">
    <li><a href="#"><i class="zmdi m-r-md zmdi-hc-lg zmdi-account-box"></i>Help</a></li>
    <li><a href="#"><i class="zmdi m-r-md zmdi-hc-lg zmdi-book"></i>Instructions</a></li>
    <li><a href="#"><i class="zmdi m-r-md zmdi-hc-lg zmdi-help"></i>Question</a></li>
