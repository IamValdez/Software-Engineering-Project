...
if (strlen($_SESSION['famsid']==0)) {
  ...
  $sql="update tblfaculty set FullName=:name,MobileNumber=:mobilenumber,Email=:email,Specialization=:sid where ID=:did";
      ...
      <div class="col-md-12">
        <div class="widget">
          <header class="widget-header">
            <h3 class="widget-title">Faculty Profile</h3>
          </header><!-- .widget-header -->
          <hr class="widget-separator">
          <div class="widget-body">
            <?php
$did=$_SESSION['famsid'];
$sql="SELECT tblfaculty.*,tblspecialization.ID as sid,tblspecialization.Specialization as sssp from  tblfaculty join tblspecialization on tblspecialization.ID=tblfaculty.Specialization where tblfaculty.ID=:did";
$query = $dbh -> prepare($sql);
$query->bindParam(':did',$did,PDO::PARAM_STR);
$query->execute();
